...
local DEFAULT_STEALTH_LABEL = L["CooldownPanelStanceStealth"] or "Stealth"
local DEFAULT_STANCE_LABEL = L["CooldownPanelStanceType"] or "Stance"
local DEFAULT_BEAR_LABEL = L["CooldownPanelStanceBearForm"] or "Bear Form"
local DEFAULT_CAT_LABEL = L["CooldownPanelStanceCatForm"] or "Cat Form"
local DEFAULT_MOONKIN_LABEL = L["CooldownPanelStanceMoonkinForm"] or "Moonkin Form"
local DEFAULT_DEVOTION_AURA_LABEL = L["CooldownPanelStanceDevotionAura"] or "Devotion Aura"
local DEFAULT_CONCENTRATION_AURA_LABEL = L["CooldownPanelStanceConcentrationAura"] or "Concentration Aura"
local DEFAULT_CRUSADER_AURA_LABEL = L["CooldownPanelStanceCrusaderAura"] or "Crusader Aura"
local DEFAULT_SHADOWFORM_LABEL = L["CooldownPanelStanceShadowform"] or "Shadowform"
local DEFAULT_BATTLE_STANCE_LABEL = L["CooldownPanelStanceBattleStance"] or "Battle Stance"
local DEFAULT_DEFENSIVE_STANCE_LABEL = L["CooldownPanelStanceDefensiveStance"] or "Defensive Stance"
local DEFAULT_BERSERKER_STANCE_LABEL = L["CooldownPanelStanceBerserkerStance"] or "Berserker Stance"
...
local STANCE_DEFINITIONS = {
	...
	PRIEST_SHADOWFORM = {
		...
		classTag = "PRIEST",
		stanceKey = "SHADOWFORM",
		spellID = 232698, -- Shadowform
		label = DEFAULT_SHADOWFORM_LABEL,
		icon = SHADOWFORM_ICON,
		condition = "[form:1] show; hide",
	},
