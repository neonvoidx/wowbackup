...
L:RegisterLocale("esES", function() return {
	...
	["Show swipe"] = "Mostrar barrido",
	["Shows the cooldown swipe animation on this group's icons."] = "Muestra la animación de reutilización en los iconos de este grupo.",
	...
	["Displays your selected aura icon instead of the spell icon."] = "Muestra el icono de aura que has elegido en lugar del icono del hechizo.",
	...
	["Countdown Colours"] = "Colores de la cuenta atrás",
	["Under 5s"] = "Menos de 5s",
	["Under 1m"] = "Menos de 1m",
	["Above 1m"] = "Más de 1m",
	["Countdown text colour in the last five seconds."] = "Color del texto de la cuenta atrás en los últimos cinco segundos.",
	["Countdown text colour under a minute."] = "Color del texto de la cuenta atrás por debajo de un minuto.",
	["Countdown text colour above a minute."] = "Color del texto de la cuenta atrás por encima de un minuto.",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "Escala la cuenta atrás, las acumulaciones y el nombre en la barra de este grupo.",
	...
	["Disables the countdown timer text on all icons. The cooldown swipe animation will still be shown."] = "Desactiva el texto del temporizador en todos los iconos. La animación de barrido (gráfico circular) del tiempo de reutilización seguirá mostrándose.",
	...
	["No more sound failures will be reported this session."] = "No se informarán más fallos de sonido en esta sesión.",
	...
	["Sound registration failed. Spell %s, unit %s, trigger %s, file %s, channel %s."] = "Fallo al registrar el sonido. Hechizo %s, unidad %s, disparador %s, archivo %s, canal %s.",
	...
	["Icon Text Scale"] = "Escala del texto de iconos",
	["Scales this module's countdown text, leaving the icon size alone."] = "Escala el texto de cuenta atrás de este módulo sin cambiar el tamaño del icono.",
	["General"] = "General",
	...
	["Sorry folks, had to remove the animated glows as they were causing FPS issues."] = "Lo siento, gente, he tenido que quitar los brillos animados porque causaban problemas de FPS.",
	...
	["Colour every icon by its owner's class instead of by category. Arena opponents are coloured from their specialisation; battlegrounds keep the category colours, because the game will not name a class in there."] = "Colorea cada icono según la clase de su portador en lugar de por categoría. Los rivales de arena se colorean a partir de su especialización; en los campos de batalla se mantienen los colores por categoría, porque ahí el juego no revela la clase.",
	...
	["Prints extra messages in chat to help track down problems."] = "Muestra mensajes adicionales en el chat para ayudar a encontrar problemas.",
	...
	["For spec"] = "Para especialización",
	["All specs"] = "Todas las especializaciones",
	["%d specs"] = "%d especializaciones",
	["Add a spell"] = "Añadir hechizo",
	["Record"] = "Grabar",
	["Stop"] = "Detener",
	["Recorded Auras"] = "Auras grabadas",
	["Records the auras you gain so you can add them without looking up IDs."] = "Graba las auras que recibes para añadirlas sin buscar sus IDs.",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "No se graba nada en combate, ni en ningún otro sitio donde el cliente oculte tus auras.",
	["Export"] = "Exportar",
	...
	["Dispellable by raid"] = "Disipable por el grupo",
	...
	["On a unit you can help, shows only the buffs you cast yourself."] = "En una unidad a la que puedes ayudar, muestra solo los beneficios que has lanzado tú.",
	["On a unit you cannot help, shows only the debuffs you applied yourself."] = "En una unidad a la que no puedes ayudar, muestra solo los perjuicios que has aplicado tú.",
	...
	["Shows only the buffs you cast yourself."] = "Muestra solo los beneficios que has lanzado tú.",
	["Shows only the debuffs somebody in the group can dispel."] = "Muestra solo los perjuicios que alguien del grupo puede disipar.",
	...
	["Scales this row's countdown and stack count text."] = "Escala la cuenta atrás y las acumulaciones de esta fila.",
