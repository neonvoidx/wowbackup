...
L:RegisterLocale("ptBR", function() return {
	...
	["Show swipe"] = "Mostrar varredura",
	["Shows the cooldown swipe animation on this group's icons."] = "Mostra a animação de recarga nos ícones deste grupo.",
	...
	["Displays your selected aura icon instead of the spell icon."] = "Mostra o ícone de aura que você escolheu no lugar do ícone da magia.",
	...
	["Anchor"] = "Âncora",
	["Which point of the unit frame this is pinned to."] = "O ponto do quadro da unidade ao qual isto está ancorado.",
	["Grow"] = "Crescer",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "Ajusta a contagem, os acúmulos e o nome na barra deste grupo.",
	...
	["No more sound failures will be reported this session."] = "Nenhuma outra falha de som será relatada nesta sessão.",
	...
	["Icon Text Scale"] = "Escala do texto do ícone",
	["Scales this module's countdown text, leaving the icon size alone."] = "Ajusta o tamanho do texto de contagem deste módulo sem mudar o tamanho do ícone.",
	["General"] = "Geral",
	...
	["Show a class coloured border around the kick icons."] = "Mostra uma borda na cor da classe ao redor dos ícones de interrupção.",
	["Unknown kicks"] = "Interrupções desconhecidas",
	["What to show for a kick that cannot be identified."] = "O que mostrar para uma interrupção que não pode ser identificada.",
	["Class crest"] = "Brasão de classe",
	["Generic kick icon"] = "Ícone genérico de interrupção",
	...
	["Prints extra messages in chat to help track down problems."] = "Mostra mensagens extras no chat para ajudar a identificar problemas.",
	...
	["For spec"] = "Para especialização",
	["All specs"] = "Todas as especializações",
	["%d specs"] = "%d especializações",
	["Add a spell"] = "Adicionar magia",
	["Record"] = "Gravar",
	["Stop"] = "Parar",
	["Recorded Auras"] = "Auras gravadas",
	["Records the auras you gain so you can add them without looking up IDs."] = "Grava as auras que você recebe para adicioná-las sem procurar os IDs.",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "Nada é gravado em combate, nem em qualquer outro lugar onde o cliente oculta suas auras.",
	["Export"] = "Exportar",
	...
	["Dispellable by raid"] = "Dissipável pelo grupo",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "Mostra apenas as penalidades que alguém do grupo consegue dissipar.",
	...
	["Scales this row's countdown and stack count text."] = "Ajusta a contagem e os acúmulos desta linha.",
