...
L:RegisterLocale("esMX", function() return {
	...
	["Displays your selected aura icon instead of the spell icon."] = "Muestra el icono de aura que elegiste en lugar del icono del hechizo.",
	...
	["Show a class coloured border around the kick icons."] = "Muestra un borde con el color de clase alrededor de los íconos de interrupción.",
	["Unknown kicks"] = "Interrupciones desconocidas",
	["What to show for a kick that cannot be identified."] = "Qué mostrar cuando no se pueda identificar una interrupción.",
	["Class crest"] = "Emblema de clase",
	["Generic kick icon"] = "Ícono de interrupción genérico",
