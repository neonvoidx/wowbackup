...
L:RegisterLocale("deDE", function() return {
	...
	["Show swipe"] = "Wischanimation an",
	["Shows the cooldown swipe animation on this group's icons."] = "Zeigt die Abklingzeit-Animation auf den Symbolen dieser Gruppe an.",
	...
	["Displays your selected aura icon instead of the spell icon."] = "Zeigt das von dir gewählte Aura-Symbol anstelle des Zaubersymbols.",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "Skaliert Zeittext, Stufenanzahl und Leistenname dieser Gruppe.",
	...
	["Sound registration failed. Spell %s, unit %s, trigger %s, file %s, channel %s."] = "Sound-Registrierung fehlgeschlagen. Zauber %s, Einheit %s, Auslöser %s, Datei %s, Kanal %s.",
	...
	["Icon Text Scale"] = "Symboltext-Skalierung",
	["Scales this module's countdown text, leaving the icon size alone."] = "Skaliert den Ablauftext dieses Moduls, ohne die Symbolgröße zu ändern.",
	["General"] = "Allgemein",
	...
	["For spec"] = "Für Spezialisierung",
	["All specs"] = "Alle Spezialisierungen",
	["%d specs"] = "%d Spezialisierungen",
	["Add a spell"] = "Zauber hinzufügen",
	["Record"] = "Aufnehmen",
	["Stop"] = "Stopp",
	["Recorded Auras"] = "Aufgezeichnete Auren",
	["Records the auras you gain so you can add them without looking up IDs."] = "Zeichnet die Auren auf, die du erhältst, damit du sie ohne IDs nachzuschlagen hinzufügen kannst.",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "Im Kampf wird nichts aufgezeichnet, und auch sonst nicht, wo der Client deine Auren verbirgt.",
	["Export"] = "Exportieren",
	...
	["Dispellable by raid"] = "Von der Gruppe bannbar",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "Zeigt nur die Schwächungszauber, die irgendjemand in der Gruppe bannen kann.",
	...
	["Scales this row's countdown and stack count text."] = "Skaliert Zeittext und Stufenanzahl dieser Reihe.",
