...
L:RegisterLocale("koKR", function() return {
	...
	["Show swipe"] = "휩쓸기 표시",
	["Shows the cooldown swipe animation on this group's icons."] = "이 그룹 아이콘의 재사용 대기시간 애니메이션을 표시합니다.",
	...
	["Displays your selected aura icon instead of the spell icon."] = "선택한 오라 아이콘을 주문 아이콘 대신 표시합니다.",
	["Text colour"] = "텍스트 색상",
	...
	["Anchor"] = "기준 위치",
	["Which point of the unit frame this is pinned to."] = "이것이 고정되는 유닛 프레임의 지점입니다.",
	["Grow"] = "성장",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "이 그룹의 남은 시간, 중첩 수, 바 이름 글자 크기를 조절합니다.",
	["Relative size"] = "상대 크기",
	...
	["Font Scale"] = "글꼴 크기",
	["Icon Text Scale"] = "아이콘 글꼴 크기",
	["Scales this module's countdown text, leaving the icon size alone."] = "아이콘 크기는 그대로 두고 이 모듈의 남은 시간 글자 크기만 조절합니다.",
	["General"] = "일반",
	["Crowd Control"] = "군중 제어",
	["Kicks"] = "차단",
	["Other"] = "기타",
	...
	["Record"] = "기록",
	["Stop"] = "중지",
	["Recorded Auras"] = "기록된 효과",
	["Records the auras you gain so you can add them without looking up IDs."] = "받은 효과를 기록하여 ID를 찾지 않고도 추가할 수 있습니다.",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "전투 중이거나 클라이언트가 효과를 숨기는 다른 곳에서는 아무것도 기록되지 않습니다.",
	["Export"] = "내보내기",
	["Export All"] = "모두 내보내기",
	...
	["Dispellable by raid"] = "공격대가 해제 가능",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "공격대의 누군가가 해제할 수 있는 디버프만 표시합니다.",
	...
	["Scales this row's countdown and stack count text."] = "이 줄의 남은 시간과 중첩 수 글자 크기를 조절합니다.",
	["Show numbers"] = "숫자 표시",
