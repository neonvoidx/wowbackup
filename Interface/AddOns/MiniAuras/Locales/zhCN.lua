...
L:RegisterLocale("zhCN", function() return {
	...
	["Show swipe"] = "显示扫描",
	["Shows the cooldown swipe animation on this group's icons."] = "显示该组图标上的冷却扫描动画。",
	["Centre stacks"] = "层数居中",
	["Show the stack count in the middle of the icon instead of the countdown text."] = "在图标中央显示层数，以取代倒计时文字。",
	["Custom icon"] = "自定义图标",
	["Displays your selected aura icon instead of the spell icon."] = "显示你选择的光环图标，而不是法术图标。",
	["Text colour"] = "文字颜色",
	...
	["Anchor"] = "锚点",
	["Which point of the unit frame this is pinned to."] = "此元素固定到单位框体的哪个位置。",
	["Grow"] = "增长",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "缩放该组的倒计时、层数和条上名称文字。",
	["Relative size"] = "相对大小",
	...
	["Sound registration failed. Spell %s, unit %s, trigger %s, file %s, channel %s."] = "声音注册失败。法术 %s，单位 %s，触发 %s，文件 %s，声道 %s。",
	...
	["Export Profile"] = "导出配置",
	["Font Scale"] = "字体缩放",
	["Icon Text Scale"] = "图标文字缩放",
	["Scales this module's countdown text, leaving the icon size alone."] = "缩放该模块图标上的倒计时文字，不改变图标大小。",
	["General"] = "常规",
	["Crowd Control"] = "控场",
	["Kicks"] = "打断",
	["Other"] = "其他",
	...
	["Show a class coloured border around the kick icons."] = "在打断图标周围显示职业颜色的边框。",
	["Unknown kicks"] = "未知打断",
	["What to show for a kick that cannot be identified."] = "无法识别的打断显示什么图标。",
	["Class crest"] = "职业徽章",
	["Generic kick icon"] = "通用打断图标",
	...
	["Debug Mode"] = "调试模式",
	["Prints extra messages in chat to help track down problems."] = "在聊天框中显示额外的消息，帮助追踪问题。",
	...
	["Record"] = "录制",
	["Stop"] = "停止",
	["Recorded Auras"] = "已录制的光环",
	["Records the auras you gain so you can add them without looking up IDs."] = "录制你获得的光环，无需查找 ID 即可添加。",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "战斗中不会录制，客户端隐藏你的光环时也不会。",
	["Export"] = "导出",
	["Export All"] = "导出全部",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "只显示队伍中有人可以驱散的减益。",
	...
	["Scales this row's countdown and stack count text."] = "缩放该行的倒计时和层数文字。",
