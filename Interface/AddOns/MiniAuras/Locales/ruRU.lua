...
L:RegisterLocale("ruRU", function() return {
	...
	["Show swipe"] = "Показывать анимацию",
	["Shows the cooldown swipe animation on this group's icons."] = "Показывает анимацию восстановления на значках этой группы.",
	...
	["Displays your selected aura icon instead of the spell icon."] = "Показывает выбранный вами значок ауры вместо значка заклинания.",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "Масштабирует отсчёт, число зарядов и название на полосе этой группы.",
	...
	["Icon Text Scale"] = "Масштаб текста иконок",
	["Scales this module's countdown text, leaving the icon size alone."] = "Масштабирует текст отсчёта этого модуля, не меняя размер иконок.",
	["General"] = "Общие",
	...
	["Prints extra messages in chat to help track down problems."] = "Выводит дополнительные сообщения в чат, чтобы помочь найти проблемы.",
	...
	["For spec"] = "Для специализации",
	["All specs"] = "Все специализации",
	["%d specs"] = "%d специализации",
	["Add a spell"] = "Добавить заклинание",
	["Record"] = "Запись",
	["Stop"] = "Стоп",
	["Recorded Auras"] = "Записанные эффекты",
	["Records the auras you gain so you can add them without looking up IDs."] = "Записывает получаемые эффекты, чтобы добавлять их без поиска ID.",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "Ничего не записывается в бою и везде, где клиент скрывает ваши эффекты.",
	["Export"] = "Экспорт",
	...
	["Dispellable by raid"] = "Группа может рассеять",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "Показывает только ослабления, которые может снять кто-то из группы.",
	...
	["Scales this row's countdown and stack count text."] = "Масштабирует отсчёт и число зарядов в этом ряду.",
