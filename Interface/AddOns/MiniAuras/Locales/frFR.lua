...
L:RegisterLocale("frFR", function() return {
	...
	["Show swipe"] = "Afficher le balayage",
	["Shows the cooldown swipe animation on this group's icons."] = "Affiche l'animation de recharge sur les icônes de ce groupe.",
	...
	["Displays your selected aura icon instead of the spell icon."] = "Affiche l'icône d'aura que vous avez choisie à la place de l'icône du sort.",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "Met à l'échelle le décompte, les cumuls et le nom dans la barre de ce groupe.",
	...
	["Sound registration failed. Spell %s, unit %s, trigger %s, file %s, channel %s."] = "Échec de l'enregistrement du son. Sort %s, unité %s, déclencheur %s, fichier %s, canal %s.",
	...
	["Icon Text Scale"] = "Taille du texte des icônes",
	["Scales this module's countdown text, leaving the icon size alone."] = "Met à l'échelle le texte du décompte de ce module sans changer la taille de l'icône.",
	["General"] = "Général",
	...
	["Shows the name of the enemy who kicked, above their icon."] = "Affiche le nom de l'ennemi qui a interrompu, au-dessus de son icône.",
	["Show a class coloured border around the kick icons."] = "Affiche une bordure aux couleurs de la classe autour des icônes d'interruption.",
	["Unknown kicks"] = "Interruptions inconnues",
	["What to show for a kick that cannot be identified."] = "Ce qui s'affiche pour une interruption qui ne peut pas être identifiée.",
	["Class crest"] = "Emblème de classe",
	["Generic kick icon"] = "Icône générique d'interruption",
	...
	["Prints extra messages in chat to help track down problems."] = "Affiche des messages supplémentaires dans le chat pour aider à repérer les problèmes.",
	...
	["For spec"] = "Pour la spécialisation",
	["All specs"] = "Toutes les spécialisations",
	["%d specs"] = "%d spécialisations",
	["Add a spell"] = "Ajouter un sort",
	["Record"] = "Enregistrer",
	["Stop"] = "Arrêter",
	["Recorded Auras"] = "Auras enregistrées",
	["Records the auras you gain so you can add them without looking up IDs."] = "Enregistre les auras que vous recevez pour les ajouter sans chercher leur ID.",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "Rien n'est enregistré en combat, ni ailleurs où le client masque vos auras.",
	["Export"] = "Exporter",
	...
	["Dispellable by raid"] = "Dissipable en groupe",
	...
	["Duplicate"] = "Dupliquer",
	["Enemy Focus"] = "Focalisation ennemie",
	["Enemy Nameplates"] = "Barres d'infos ennemies",
	["Enemy Target"] = "Cible ennemie",
	["Friendly Focus"] = "Focalisation alliée",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "N'affiche que les affaiblissements qu'un membre du groupe peut dissiper.",
	...
	["Scales this row's countdown and stack count text."] = "Met à l'échelle le décompte et les cumuls de cette rangée.",
