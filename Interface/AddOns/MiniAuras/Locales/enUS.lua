...
L:SetDefaultStrings({
	...
	["Shows the cooldown swipe animation on this group's icons."] = "Shows the cooldown swipe animation on this group's icons.",
	...
	["Displays your selected aura icon instead of the spell icon."] = "Displays your selected aura icon instead of the spell icon.",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "Scales this group's countdown, stack count, and bar name text.",
	...
	["Icon Text Scale"] = "Icon Text Scale",
	["Scales this module's countdown text, leaving the icon size alone."] = "Scales this module's countdown text, leaving the icon size alone.",
	["General"] = "General",
	...
	["Record"] = "Record",
	["Stop"] = "Stop",
	["Recorded Auras"] = "Recorded Auras",
	["Records the auras you gain so you can add them without looking up IDs."] = "Records the auras you gain so you can add them without looking up IDs.",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "Nothing is recorded in combat, or anywhere else the client hides your auras.",
	["Export"] = "Export",
	...
	["Dispellable by raid"] = "Dispellable by raid",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "Shows only the debuffs somebody in the group can dispel.",
	...
	["Scales this row's countdown and stack count text."] = "Scales this row's countdown and stack count text.",
