...
L:RegisterLocale("zhTW", function() return {
	...
	["Show swipe"] = "顯示掃描",
	["Shows the cooldown swipe animation on this group's icons."] = "顯示該組圖示上的冷卻掃描動畫。",
	["Centre stacks"] = "層數置中",
	["Show the stack count in the middle of the icon instead of the countdown text."] = "在圖示中央顯示層數，以取代倒數文字。",
	["Custom icon"] = "自訂圖示",
	["Displays your selected aura icon instead of the spell icon."] = "顯示你選擇的光環圖示，而不是法術圖示。",
	["Text colour"] = "文字顏色",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "縮放該組的倒數、層數與條上名稱文字。",
	["Relative size"] = "相對大小",
	...
	["No more sound failures will be reported this session."] = "本次工作階段不再回報更多音效失敗。",
	...
	["Font Scale"] = "字體縮放",
	["Icon Text Scale"] = "圖示文字縮放",
	["Scales this module's countdown text, leaving the icon size alone."] = "縮放該模組圖示上的倒數文字，不改變圖示大小。",
	["General"] = "一般",
	["Crowd Control"] = "控場",
	["Kicks"] = "斷法",
	["Other"] = "其他",
	...
	["Tints the glow and border with the CC colour above. Dispel colours instead give it the game's debuff colours, e.g. blue for magic. None leaves the icons uncoloured."] = "用上方的控制顏色為發光和邊框著色。驅散顏色則讓它使用遊戲的減益顏色，例如魔法為藍色。無則讓圖示保持無色。",
	["None"] = "無",
	...
	["Record"] = "錄製",
	["Stop"] = "停止",
	["Recorded Auras"] = "已錄製的光環",
	["Records the auras you gain so you can add them without looking up IDs."] = "錄製你獲得的光環，不用查找 ID 即可新增。",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "戰鬥中不會錄製，客戶端隱藏你的光環時也不會。",
	["Export"] = "匯出",
	["Export All"] = "匯出全部",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "只顯示隊伍中有人可以驅散的減益。",
	...
	["Scales this row's countdown and stack count text."] = "縮放該列的倒數與層數文字。",
	["Show numbers"] = "顯示倒數數字",
