...
L:RegisterLocale("itIT", function() return {
	...
	["Show swipe"] = "Mostra animazione",
	["Shows the cooldown swipe animation on this group's icons."] = "Mostra l'animazione di recupero sulle icone di questo gruppo.",
	...
	["Displays your selected aura icon instead of the spell icon."] = "Mostra l'icona dell'aura che hai scelto al posto dell'icona dell'incantesimo.",
	...
	["Anchor"] = "Ancoraggio",
	["Which point of the unit frame this is pinned to."] = "Il punto del riquadro dell'unità a cui questo è ancorato.",
	["Grow"] = "Cresci",
	...
	["Scales this group's countdown, stack count, and bar name text."] = "Ridimensiona il conto alla rovescia, i cumuli e il nome nella barra di questo gruppo.",
	...
	["Sound registration failed. Spell %s, unit %s, trigger %s, file %s, channel %s."] = "Registrazione del suono fallita. Incantesimo %s, unità %s, attivatore %s, file %s, canale %s.",
	...
	["Icon Text Scale"] = "Scala testo icone",
	["Scales this module's countdown text, leaving the icon size alone."] = "Ridimensiona il testo del conto alla rovescia di questo modulo senza cambiare la dimensione dell'icona.",
	["General"] = "Generale",
	...
	["Shows the name of the enemy who kicked, above their icon."] = "Mostra il nome del nemico che ha interrotto, sopra la sua icona.",
	["Show a class coloured border around the kick icons."] = "Mostra un bordo del colore della classe attorno alle icone di interruzione.",
	["Unknown kicks"] = "Interruzioni sconosciute",
	["What to show for a kick that cannot be identified."] = "Cosa mostrare per un'interruzione che non può essere identificata.",
	["Class crest"] = "Stemma di classe",
	["Generic kick icon"] = "Icona generica di interruzione",
	...
	["For spec"] = "Per specializzazione",
	["All specs"] = "Tutte le specializzazioni",
	["%d specs"] = "%d specializzazioni",
	["Add a spell"] = "Aggiungi incantesimo",
	["Record"] = "Registra",
	["Stop"] = "Ferma",
	["Recorded Auras"] = "Aure registrate",
	["Records the auras you gain so you can add them without looking up IDs."] = "Registra le aure che ricevi così puoi aggiungerle senza cercare gli ID.",
	["Nothing is recorded in combat, or anywhere else the client hides your auras."] = "Non viene registrato nulla in combattimento, né altrove dove il client nasconde le tue aure.",
	["Export"] = "Esporta",
	...
	["Dispellable by raid"] = "Dissolvibile dal gruppo",
	...
	["Shows only the debuffs somebody in the group can dispel."] = "Mostra solo le penalità che qualcuno nel gruppo può dissolvere.",
	...
	["Scales this row's countdown and stack count text."] = "Ridimensiona il conto alla rovescia e i cumuli di questa riga.",
