...
function skin:Apply(mainColor, backgroundColor, bordersColor, controlsColor, desaturation)
  -- Main frame.
  self:SkinNineSliced(ClassTrainerFrame, mainColor, desaturation)

  -- Background.
  ClassTrainerFrameBg:SetDesaturation(desaturation)
  ClassTrainerFrameBg:SetVertexColor(backgroundColor[1], backgroundColor[2], backgroundColor[3], backgroundColor[4])
  ...
  -- Controls.
  self:SkinScrollBarOf(ClassTrainerFrame, controlsColor, desaturation)

  for _, texture in pairs({
    ClassTrainerFrame.FilterDropdown.Background,
  }) do
