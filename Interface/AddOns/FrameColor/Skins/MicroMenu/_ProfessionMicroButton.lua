...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = ProfessionMicroButton:GetNormalTexture(),
    ["highlightTexture"] = ProfessionMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = ProfessionMicroButton:GetPushedTexture(),
  }
