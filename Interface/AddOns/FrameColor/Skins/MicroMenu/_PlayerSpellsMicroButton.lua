...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = PlayerSpellsMicroButton:GetNormalTexture(),
    ["highlightTexture"] = PlayerSpellsMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = PlayerSpellsMicroButton:GetPushedTexture(),
  }
