...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = StoreMicroButton:GetNormalTexture(),
    ["highlightTexture"] = StoreMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = StoreMicroButton:GetPushedTexture(),
  }
