...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = GuildMicroButton:GetNormalTexture(),
    ["emblemTexture"] = GuildMicroButton.Emblem,
    ["highlightTexture"] = GuildMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = GuildMicroButton:GetPushedTexture(),
  }
  ...
  textures.emblemTexture:SetVertexColor(normalColor[1], normalColor[2], normalColor[3], normalColor[4])
