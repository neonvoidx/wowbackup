...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = CollectionsMicroButton:GetNormalTexture(),
    ["highlightTexture"] = CollectionsMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = CollectionsMicroButton:GetPushedTexture(),
  }
