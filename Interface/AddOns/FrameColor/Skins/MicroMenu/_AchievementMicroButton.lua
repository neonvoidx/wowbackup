...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = AchievementMicroButton:GetNormalTexture(),
    ["highlightTexture"] = AchievementMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = AchievementMicroButton:GetPushedTexture(),
  }
