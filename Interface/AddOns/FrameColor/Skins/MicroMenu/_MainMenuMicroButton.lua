...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = MainMenuMicroButton:GetNormalTexture(),
    ["highlightTexture"] = MainMenuMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = MainMenuMicroButton:GetPushedTexture(),
  }
