...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = HousingMicroButton:GetNormalTexture(),
    ["highlightTexture"] = HousingMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = HousingMicroButton:GetPushedTexture(),
  }
