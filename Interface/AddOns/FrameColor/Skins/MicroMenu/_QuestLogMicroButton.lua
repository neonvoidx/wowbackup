...
function skin:Apply(normalColor, highlightColor, pushedColor, desaturation)
  local textures = {
    ["normalTexture"] = QuestLogMicroButton:GetNormalTexture(),
    ["highlightTexture"] = QuestLogMicroButton:GetHighlightTexture(),
    ["pushedTexture"] = QuestLogMicroButton:GetPushedTexture(),
  }
