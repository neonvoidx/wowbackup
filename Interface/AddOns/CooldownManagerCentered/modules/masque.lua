...
local VIEWERS = {
    { name = "EssentialCooldownViewer", title = "Essential Cooldowns", id = "CMC_Essential", btype = "Action" },
    { name = "UtilityCooldownViewer", title = "Utility Cooldowns", id = "CMC_Utility", btype = "Action" },
    { name = "BuffIconCooldownViewer", title = "Tracked Buffs", id = "CMC_BuffIcons", btype = "Aura" },
}

-- Shared group for all custom trackers.
local TRACKER_GROUP = { title = "Custom Trackers", id = "CMC_Tracker", btype = "Action" }
