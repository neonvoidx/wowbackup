...
function addon.Skinner.functions.InitDB()
	...
	if addon.Skinner.functions.InitObjectiveTrackerDB then addon.Skinner.functions.InitObjectiveTrackerDB() end
...
function addon.Skinner.functions.InitSettings()
	...
	if addon.Skinner.functions.InitObjectiveTrackerSettings then addon.Skinner.functions.InitObjectiveTrackerSettings(category, expandable) end
end
