...
L["settings.groupAge.title"] = "Возраст группы"
L["settings.groupAge.tooltip"] = "Показывает возраст группы слева от стиля игры. Нельзя использовать вместе с компактными элементами списка."
