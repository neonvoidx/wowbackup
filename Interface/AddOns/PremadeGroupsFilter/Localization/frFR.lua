...
L["settings.groupAge.title"] = "Âge du groupe"
L["settings.groupAge.tooltip"] = "Affiche l’âge d’un groupe à gauche du style de jeu. Ne peut pas être utilisé avec les entrées de liste compactes."
