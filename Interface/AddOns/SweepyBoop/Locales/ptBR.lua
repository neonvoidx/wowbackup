...
L["\124cFF00FF00Type /sb\124r or click the minimap icon to open the option panel."] = "\124cFF00FF00Digite /sb\124r ou clique no ícone do minimapa para abrir o painel de opções.";
...
L["A lightweight ring, GCD indicator, and fading trail around your mouse cursor."] = "Um anel leve, indicador de GCD e rastro que desaparece ao redor do cursor do mouse.";
L["Baseline ring"] = "Anel base";
L["Trail"] = "Rastro";
L["GCD ring"] = "Anel de GCD";
L["Baseline color"] = "Cor base";
L["GCD color"] = "Cor do GCD";
L["Trail color"] = "Cor do rastro";
L["Ring size"] = "Tamanho do anel";
L["GCD ring size"] = "Tamanho do anel de GCD";
L["Scale"] = "Escala";
L["Opacity"] = "Opacidade";
L["Trail duration"] = "Duração do rastro";
L["Trail density"] = "Densidade do rastro";
L["Trail size"] = "Tamanho do rastro";
L["Smart macros"] = "Macros inteligentes";
L["Smart healer macros"] = "Macros inteligentes de curador";
L["Show healer icon on arena frames"] = "Mostrar ícone de curador nos quadros da arena";
L["Marks the detected enemy healer on supported arena frames so it is easier to match Smart macro targeting to the frame."] = "Marca o curador inimigo detectado nos quadros de arena compatíveis para facilitar a correspondência do alvo da macro inteligente com o quadro.";
L["Focus arena macros"] = "Macros de foco da arena";
L["Add SBM to a macro name to let SweepyBoop retarget its @focus casts to the enemy healer in arena.\n\nWhen a healer is detected, @focus becomes @arena1, @arena2, or @arena3. Outside arena, or if no healer is found, it changes back to @focus."] = "Adicione SBM ao nome de uma macro para permitir que SweepyBoop redirecione seus lançamentos @focus para o curador inimigo na arena.\n\nQuando um curador é detectado, @focus vira @arena1, @arena2 ou @arena3. Fora da arena, ou se nenhum curador for encontrado, volta para @focus.";
L["How it works"] = "Como funciona";
L["Only macro names containing case-sensitive SBM are edited.\n\nSweepyBoop only changes explicit target tokens: @focus and @arena1 through @arena5. All other macro text is left unchanged.\n\nIf combat blocks macro edits, the update is applied after combat ends."] = "Somente nomes de macro contendo SBM com maiúsculas exatas são editados.\n\nSweepyBoop altera apenas tokens de alvo explícitos: @focus e @arena1 até @arena5. Todo o resto do texto fica igual.\n\nSe o combate bloquear a edição de macros, a atualização é aplicada após o fim do combate.";
L["Example"] = "Exemplo";
L["Name:\nSBM Cyclone\n\nBefore arena:\n#showtooltip\n/cast [@focus] Cyclone\n\nIf the healer is arena2:\n#showtooltip\n/cast [@arena2] Cyclone\n\nAfter arena, it returns to @focus."] = "Nome:\nSBM Cyclone\n\nAntes da arena:\n#showtooltip\n/cast [@focus] Cyclone\n\nSe o curador for arena2:\n#showtooltip\n/cast [@arena2] Cyclone\n\nDepois da arena, volta para @focus.";
L["Important details"] = "Detalhes importantes";
L["Create the macro yourself and use @focus as the default target.\n\nAdd SBM only to macros SweepyBoop should manage. Leave it out of macros that must keep a fixed arena target."] = "Crie a macro você mesmo e use @focus como alvo padrão.\n\nAdicione SBM somente às macros que SweepyBoop deve gerenciar. Deixe fora de macros que precisam manter um alvo fixo da arena.";
L["General"] = "Geral";
...
L["Show decimal countdowns below this many seconds."] = "Mostra decimais abaixo desta quantidade de segundos.";
...
L["Friendly class icons"] = "Ícones aliados";
L["Show class/pet icons on friendly players/pets"] = "Ícones aliados";
L["Show spec icons in PvP instances"] = "Especialização PvP";
...
L["Enable \"Friendly Player Nameplates\" in Interface - Nameplates for pet icons"] = "Ative placas aliadas";
...
L["Special icon for healers"] = "Ícone de curador";
L["Show healers only"] = "Só curadores";
...
L["Pet"] = "Pet";
L["Class-colored names"] = "Nomes de classe";
...
L["Arena enemy spec icons"] = "Especialização inimiga";
L["Show spec icon for healers"] = "Curadores";
...
L["Show healer icon instead of spec icon for healers"] = "Ícone de curador";
L["Show spec icon for non-healers"] = "Não curadores";
...
L["Hide beast mastery hunter secondary pets in arena"] = "Ocultar pets BM";
...
L["Highlight important enemy summons"] = "Invocações-chave";
L["Customize enemy units to hide / show / highlight"] = "Unidades inimigas";
...
L["Show critter icons for hidden pet nameplates"] = "Pets ocultos";
...
L["Filter debuffs applied by myself"] = "Minhas penalidades";
...
L["Show whitelisted buffs on enemy nameplates"] = "Bônus permitidos";
L["Show whitelisted buffs on enemy nameplates from all sources"] = "Mostrar bônus permitidos de todas as fontes";
L["Unit whitelist"] = "Lista branca de unidades";
L["Debuff whitelist"] = "Penalidades permitidas";
L["Buff whitelist"] = "Bônus permitidos";
...
L["Hide countdown numbers but show a more visible swiping edge"] = "Oculta números e mostra uma borda mais visível";
...
L["Thickness of the black marker outline."] = "Thickness of the black marker outline.";
L["Point on the indicator group used for positioning and first-icon placement."] = "Point on the indicator group used for positioning and first-icon placement.";
L["Relative To"] = "Relative To";
L["Point on the Blizzard frame that the indicator group attaches to."] = "Point on the Blizzard frame that the indicator group attaches to.";
L["TOPLEFT"] = "Top left";
L["TOP"] = "Top";
...
L["Direction additional target indicators grow from the first indicator. Centered modes place the full indicator group on the configured relative point."] = "Direction additional target indicators grow from the first indicator. Centered modes place the full indicator group on the configured relative point.";
L["UP"] = "Up";
L["DOWN"] = "Down";
L["CENTER_HORIZONTAL"] = "Center horizontal";
L["CENTER_VERTICAL"] = "Center vertical";
L["Spacing"] = "Spacing";
L["Spacing between multiple indicators."] = "Spacing between multiple indicators.";
L["Horizontal offset from the selected frame point."] = "Horizontal offset from the selected frame point.";
L["Vertical offset from the selected frame point."] = "Vertical offset from the selected frame point.";
