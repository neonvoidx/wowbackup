...
L["Cast Animations"] = "시전 애니메이션"
L["Cooldown Animations"] = "재사용 대기 애니메이션"
L["Enable animations when action button cooldowns finish."] = "행동 단축바 버튼의 재사용 대기시간 애니메이션을 활성화합니다."
L["Enable cast animations on action buttons."] = "행동 단축바 버튼의 시전 애니메이션을 활성화합니다."
L["Enable interrupt animations on action buttons."] = "행동 단축바 버튼의 중단 애니메이션을 활성화합니다."
-- L["Enable targeting reticles on action buttons."] = "Enable targeting reticles on action buttons."
L["Flash and Loop"] = "번쩍임과 테두리 효과"
L["Interrupt Animations"] = "중단 애니메이션"
L["Loop Only"] = "테두리 효과"
L["Select the spell alert style."] = "주문 경고 스타일 선택"
L["Select which spell alert animations are enabled."] = "주문 경고 애니메이션을 선택합니다."
L["Spell Alert Animations"] = "주문 경고 애니메이션"
L["Spell Alert Style"] = "주문 경고 스타일"
-- L["Targeting Reticles"] = "Targeting Reticles"
L["This section will allow you to adjust button settings for the default interface."] = "이 섹션에서는 기본 인터페이스의 버튼 설정을 조정할 수 있습니다."
...
L["Increases the font size of the text on Ace3 profile panels."] = "Ace3 프로필 패널의 글꼴 크기를 키웁니다."
L["Interface"] = "인터페이스"
...
L["Minimap"] = "미니맵 버튼"
L["None"] = "없음"
L["Profile Panel Font Fix"] = "프로필 패널 글꼴 수정"
L["Reload Interface"] = "인터페이스 새로 고침"
L["Requires an interface reload."] = "인터페이스 다시 불러와야 합니다."
L["Select where Masque's menu icon is displayed."] = "Masque의 메뉴 아이콘을 어디에 배치할지 선택합니다."
...
L["Unavailable in combat."] = "전투에서 사용할 수 없습니다."
