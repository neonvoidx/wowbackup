...
L["Automatically purchase Skyriding talents when you have enough currency."] = "当您拥有足够货币时自动购买驭空术天赋。"
...
L["Change Scale"] = "调整缩放"
L["Choose how the mini tree is displayed. 'with diff' means that the mini tree will show the difference between your current build and the build in the tooltip."] = "选择迷你天赋树的显示方式。“显示差异”意味着迷你天赋树将显示当前构建和鼠标提示中的构建之间的差异。"
...
L["Opens Blizzard's table inspect window."] = "打开暴雪的表检查窗口。"
...
L["Toggle %s UI"] = "切换 %s 界面"
L["Toggle D.R.I.V.E. UI"] = "切换D.R.I.V.E.界面"
L["Toggle Horrific Visions UI"] = "切换惊魂幻象界面"
L["Toggle Skyriding UI"] = "打开驭空术界面"
...
L["Toggle the Horrific Visions UI to view and adjust talents."] = "切换惊魂幻象界面以查看和调整天赋。"
L["Toggle the Skyriding UI to view and adjust talents."] = "打开驭空术界面以查看和调整天赋。"
