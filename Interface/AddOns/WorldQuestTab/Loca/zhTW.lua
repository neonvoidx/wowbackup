...
L["PIN_FACTION_TT"] = "使用任務陣營的材質。"
L["PIN_FADE_ON_PING"] = "突顯後淡出"
L["PIN_FADE_ON_PING_TT"] = "當一個地圖任務點被突顯時，淡出其他所有任務點以提高可視性。"
L["PIN_LABEL"] = "標簽"
L["PIN_LABEL_COLORS"] = "標簽著色"
L["PIN_LABEL_COLORS_TT"] = "根據差異對標簽著色。"
L["PIN_LABEL_NONE_TT"] = "不顯示標簽。"
L["PIN_LABEL_REWARD"] = "獎勵數值"
L["PIN_LABEL_REWARD_TT"] = "顯示主要獎勵的數值。"
L["PIN_LABEL_TT"] = "任務點下方顯示文字標簽。"
...
L["PIN_TRACKING_GLOW_TT"] = "從清單上被設為目前焦點的任務，會在地圖上閃光。"
L["PIN_TRACKING_ICON"] = "聚焦圖示"
L["PIN_TRACKING_ICON_TT"] = "被設為當前焦點的任務，會在下方添加一個圖標，更加醒目。"
L["PIN_TYPE"] = "任務類型圖示"
...
L["WHATS_NEW"] = "更新說明"
L["ZONE_QUESTS"] = "任務區劃"
L["ZONE_QUESTS_EXPANSION"] = "資料片涉及"
L["ZONE_QUESTS_EXPANSION_TT"] = "（任務列表）涵蓋所屬資料片的全部任務。"
...
L["ZONE_QUESTS_ZONE_TT"] = "只顯示當前區域的任務。|n註: 任務所屬的地區是由暴雪的API所決定的。"
