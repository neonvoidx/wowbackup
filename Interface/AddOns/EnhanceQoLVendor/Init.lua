...
function addon.Vendor.functions.InitFilterState()
...
function addon.Vendor.functions.InitState()
	if addon.Vendor.functions.InitFilterState then addon.Vendor.functions.InitFilterState() end
end
