...
local function EQOL_HighlightSearchEntry(entry)
	...
	local ignored = false
	if addon.functions.IsAdvancedIgnoreEnabled and addon.functions.IsAdvancedIgnoreEnabled() and info and info.leaderName then ignored = addon.Ignore:CheckIgnore(info.leaderName) and true or false end
