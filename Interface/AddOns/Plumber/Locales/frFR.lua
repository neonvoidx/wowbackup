...
L["LootUI Option Custom Quality Color Tooltip"] = "Utiliser les couleurs que vous définissez dans Options > Accessibilité > Couleurs."
...
L["PlumberMacro Error Combat"] = "Indisponible au combat";
...
L["Weekly Cap"] = "Plafond hebdomadaire";
L["Weekly Cap Reached"] = "Plafond hebdomadaire atteint.";
L["Instruction Right Click To Use"] = "<Clic droit pour utiliser>";
L["Join Queue"] = WOW_LABS_JOIN_QUEUE or "Rejoindre la file d'attente";
L["In Queue"] = BATTLEFIELD_QUEUE_STATUS or "Dans la file d'attente";
L["Click To Switch"] = "Cliquez pour changer vers |cffffffff%s|r";
L["Click To Queue"] = "Cliquez pour faire la queue pour |cffffffff%s|r";
