...
elseif locale == "frFR" then
	...
	L["All stored bugs have been exterminated painfully."] = "Tous les bugs enregistrés ont été exterminés douloureusement."
	L["altWipeDesc"] = "Alt + Clic sur l’icône de la mini-carte pour supprimer tous les bugs enregistrés."
	L["autoDesc"] = "Ouvre automatiquement BugSack lorsqu’une erreur est détectée, sauf en combat."
	L["Auto popup"] = "Popup automatique"
	L.minimapHint = "|cffeda55fCliquez|r pour ouvrir BugSack avec le dernier bug\n|cffeda55fMaj + Clic droit|r pour recharger l’interface\n|cffeda55fClic droit|r pour ouvrir les options"
	L["|cffff4411BugSack requires the |r|cff44ff44!BugGrabber|r|cffff4411 addon, which you can download from the same place you got BugSack. Happy bug hunting!|r"] = "|cffff4411BugSack nécessite l’AddOn |r|cff44ff44!BugGrabber|r|cffff4411, que vous pouvez télécharger au même endroit que BugSack. Bonne chasse aux bugs !|r"
	L["chatFrameDesc"] = "Affiche un rappel dans la fenêtre de discussion lorsqu’une erreur est détectée. N’affiche pas toute l’erreur, juste un rappel !"
	L["Chatframe output"] = "Sortie vers la fenêtre de discussion"
	L["Current session"] = "Session actuelle"
	L["%d bugs have been sent to %s. He must have BugSack to be able to examine them."] = "%d bugs ont été envoyés à %s. Il doit avoir BugSack installé pour pouvoir les examiner."
	L["Failure to deserialize incoming data from %s."] = "Échec de désérialisation des données reçues de %s."
	L["Filter"] = "Filtre"
	L["Filter addon mistakes"] = "Filtrer les erreurs d’AddOns"
	L["filterDesc"] = "Détermine si BugSack doit traiter les événements ADDON_ACTION_BLOCKED et ADDON_ACTION_FORBIDDEN comme des bugs. Si cela n’a pas de sens pour vous, ignorez cette option."
	L["Font size"] = "Taille de police"
	L["Large"] = "Grande"
	L["Limit"] = "Limite"
	L["Local (%s)"] = "Locale (%s)"
	L["Medium"] = "Moyenne"
	L["minimapDesc"] = "Affiche l’icône de BugSack autour de la mini-carte."
	L["Minimap icon"] = "Icône mini-carte"
	L["Minimap icon alt-click wipe"] = "Alt + Clic sur mini-carte pour nettoyage"
	L["Mute"] = "Muet"
	L["muteDesc"] = "Empêche BugSack de jouer un son lorsque un bug est détecté, peu importe le son sélectionné ci-dessous."
	L["Next >"] = "Suivant >"
	L["Player needs to be a valid name."] = "Le nom du joueur doit être valide."
	L["< Previous"] = "< Précédent"
	L["Previous session"] = "Session précédente"
	L["saveDesc"] = "Enregistre les bugs dans la base de données. Si cette option est désactivée, les bugs ne seront pas conservés entre les sessions."
	L["Save errors"] = "Sauvegarder les erreurs"
	L["Send"] = "Envoyer"
	L["Send all bugs from the currently viewed session (%d) in the sack to the player specified below."] = "Envoyer tous les bugs de la session actuelle (%d) au joueur spécifié ci-dessous."
	L["Send bugs"] = "Envoyer les bugs"
	...
	L["Quick tips"] = "Astuces rapides"
	L["quickTipsDesc"] = "|cff44ff44Double clic|r pour filtrer les rapports de bugs. Pour revenir à la liste complète, sélectionnez un onglet en bas\n|cff44ff44Clic gauche|r pour déplacer la fenêtre\n|cff44ff44Clic droit|r pour fermer le sac et ouvrir les options de BugSack."
	L["wipeDesc"] = "Supprime tous les bugs enregistrés dans la base de données."
	L["Wipe saved bugs"] = "Effacer les bugs enregistrés"
	L["X-Large"] = "Très grande"
	L["You have no bugs, yay!"] = "Aucun bug détecté, hourra !"
	L["You've received %d bugs from %s."] = "Vous avez reçu %d bugs de %s."
	L.useMaster = "Utiliser le canal audio 'Master'"
	L.useMasterDesc = "Joue le son d’erreur sélectionné via le canal audio 'Master' au lieu du canal par défaut."
	L.addonCompartment = "Icône du compartiment d’AddOn"
	L.addonCompartment_desc = "Ajoute une entrée pour BugSack dans le compartiment d’AddOn."
...
elseif locale == "ruRU" then
	...
	L["All bugs"] = "Все баги"
	L["All stored bugs have been exterminated painfully."] = "Все сохраненные баги были тщательно уничтожены."
	L["altWipeDesc"] = "Позволить Alt-щелчок по иконке на миникарте, чтобы очистить все имеющиеся ошибки."
	L["Auto popup"] = "Автоматическое всплывающее окно"
	L["autoDesc"] = "Автоматически открывает окошко BugSack при возникновении ошибки, но только если Вы не в бою."
	...
	L["minimapDesc"] = "Показывать иконку BugSack на миникарте."
	L["Mute"] = "Без звука"
	...
	L["Send"] = "Отправить"
	L["Send all bugs from the currently viewed session (%d) in the sack to the player specified below."] = "Отправить все баги из текущей просматриваемой сессии (%d) игроку, указанному ниже."
	L["Send bugs"] = "Отправить баги"
	...
	L["quickTipsDesc"] = "|cff44ff44Двойной щелчок|r - отфильтровать баги. После того, как Вы закончите с результатами поиска, вернитесь к полному списку, выбрав вкладку внизу.\n|cff44ff44ЛКМ + перемещение|r - переместить окно.\n|cff44ff44ПКМ|r - закрыть мешок и открыть настройки BugSack."
	...
	L.addonCompartment = "Иконка в отделении для аддонов"
	L.addonCompartment_desc = "Показывать иконку BugSack в 'Отделении для аддонов'."
