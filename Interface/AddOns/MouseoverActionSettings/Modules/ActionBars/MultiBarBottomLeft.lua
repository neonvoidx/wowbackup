...
local mo_unit = {
    Parents = {MultiBarBottomLeft},
    visibilityEvent = "MULTI_BAR_BOTTOM_LEFT_UPDATE",   
    scriptRegions = {},
    statusEvents = {},
}
for i=1,12 do
    mo_unit.scriptRegions[i] = _G["MultiBarBottomLeftButton" .. i]
end
...
function module:OnEnable()
    local dbObj = addon.db.profile["MultiBarBottomLeft"]
