...
local mo_unit = {
    Parents = {StatusTrackingBarManager},
    visibilityEvent = "TRACKING_BAR_UPDATE",   
    scriptRegions = {
...
local module = addon:NewModule("TrackingBarContainer")

function module:OnEnable()
    local dbObj = addon.db.profile["TrackingBarContainer"]
