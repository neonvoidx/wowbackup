...
L["config_remove_AreaPois"] = "Удалить объекты Blizzard, отмеченные точкой на карте для пунктов назначения"
L["config_remove_AreaPois_desc"] = "Это приведет к удалению отмеченных точек (POI), установленных Blizzard для пунктов назначения на карте мира."
...
L["Elevator to Isle of Dorn"] = "Подъёмник на Остров Дорн"
L["Elevator to Ringing Deeps"] = "Подъёмник в Гулкие глубины"
...
L["Hot Air Balloon to Orgrimmar"] = "Воздушный шар в Оргриммар"
L["Hot Air Balloon to Stormwind"] = "Воздушный шар в Штормград"
L["Hot Air Balloon to Wandering Isle"] = "Воздушный шар на Скитающийся остров"
