...
function EASYSCRAP_AUTOCAST_START(obj)
	obj:ShowAutoCastEnabled(true)
end


function EASYSCRAP_AUTOCAST_STOP(obj)
	obj:ShowAutoCastEnabled(false)
end
