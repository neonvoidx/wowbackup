...
local filterSelection = CreateFrame("DropdownButton", "EasyScrapFilterSelectionMenu", mainFrame, "WowStyle1DropdownTemplate")
filterSelection:SetDefaultText("Default")
filterSelection:SetWidth(96)
filterSelection:SetPoint("LEFT", mainFrame.searchBox, "RIGHT", 86, 0)
...
filterSelection.text:SetPoint('RIGHT', filterSelection, 'LEFT', -4, 0)
