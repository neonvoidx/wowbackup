...
local function registerConfigCenterSettings()
	...
	addon.Bags.variables.configCenterSettingsBuilt = true
end

registerConfigCenterSettings()
...
local PAGE_ORDER = {
	{
		...
		placeholderText = "L",
		iconTexture = "Interface\\AddOns\\EnhanceQoLBags\\Media\\Layout",
		iconSize = 20,
	},
	{
		id = "categories",
		...
		placeholderText = "#",
		iconTexture = "Interface\\AddOns\\EnhanceQoLBags\\Media\\Category",
		iconSize = 20,
	},
	{
		id = "overlays",
		...
		placeholderText = "*",
		iconTexture = "Interface\\AddOns\\EnhanceQoLBags\\Media\\Overlay",
		iconSize = 20,
	},
	{
		id = "footer",
		...
		placeholderText = "$",
		iconTexture = "Interface\\AddOns\\EnhanceQoLBags\\Media\\Currency",
		iconSize = 20,
	},
	{
		id = "tracking",
