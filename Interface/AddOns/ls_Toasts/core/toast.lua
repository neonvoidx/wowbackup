...
local function constructToast()
	...
	local border = addon.Border:Create(toast, "BACKGROUND", 1)
	toast.Border = border
	...
	local iconBorder = addon.Border:Create(iconParent, "BACKGROUND", 5)
	iconBorder:Hide()
	...
	for i = 1, 5 do
		...
		local slotBorder = addon.Border:Create(slot, "BACKGROUND", 2)
