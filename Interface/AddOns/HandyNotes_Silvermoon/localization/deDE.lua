local L = LibStub("AceLocale-3.0"):NewLocale("HandyNotes_Silvermoon", "deDE", false, true)
...
L["config_plugin_desc"] = "Zeigt die Positionen von NPCs und anderer POIs in Silbermond auf der Weltkarte und Minimap an."
