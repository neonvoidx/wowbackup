local L = LibStub("AceLocale-3.0"):NewLocale("HandyNotes_Silvermoon", "ruRU", false, true)
...
L["config_plugin_name"] = "Луносвет"
L["config_plugin_desc"] = "Показывает на карте мира и миникарте местоположения НИПов и достопримечательностей в Луносвете."
...
L["config_easy_waypoints_desc"] = "Активирует упрощённое создание путевой точки. Позволяет установить путевую точку, щёлкнув ПКМ, и получить доступ к дополнительным параметрам, нажав Ctrl+[ПКМ]."
