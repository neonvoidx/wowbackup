...
local function guiGeneralTab()
    ...
    -- local levelOptionsFrame
    -- local function OpenLevelOptionsWindow()
    --     if not levelOptionsFrame then
    --         -- Create the frame
    --         levelOptionsFrame = CreateFrame("Frame", "LevelOptionsFrame", UIParent, "BasicFrameTemplateWithInset")
    --         levelOptionsFrame:SetSize(185, 130)
    --         levelOptionsFrame:SetPoint("CENTER")
    --         levelOptionsFrame:SetFrameStrata("DIALOG")
    --         levelOptionsFrame:SetMovable(true)
    --         levelOptionsFrame:EnableMouse(true)
    --         levelOptionsFrame:RegisterForDrag("LeftButton")
    --         levelOptionsFrame:SetScript("OnDragStart", levelOptionsFrame.StartMoving)
    --         levelOptionsFrame:SetScript("OnDragStop", levelOptionsFrame.StopMovingOrSizing)
    ...
    --         -- Checkbox data
    --         local options = {
    --             { label = "Hide level on Players", var = "hideLevelOnPlayers" },
    --             { label = "Hide level on Friendly", var = "hideLevelOnFriendly" },
    --         }

    --         local previousCheckbox
    --         for i, option in ipairs(options) do
    --             local checkbox = CreateFrame("CheckButton", nil, levelOptionsFrame, "UICheckButtonTemplate")
    --             checkbox:SetSize(24, 24)
    --             checkbox.Text:SetText(option.label)

    --             -- Position the checkboxes
    --             if i == 1 then
    --                 checkbox:SetPoint("TOPLEFT", levelOptionsFrame, "TOPLEFT", 10, -30)
    --             else
    --                 checkbox:SetPoint("TOPLEFT", previousCheckbox, "BOTTOMLEFT", 0, -5)
    --             end

    --             -- Set the state from the DB
    --             checkbox:SetChecked(BetterBlizzPlatesDB[option.var])

    --             -- Save the state back to the DB when toggled
    --             checkbox:SetScript("OnClick", function(self)
    --                 BetterBlizzPlatesDB[option.var] = self:GetChecked() or nil
    --             end)

    --             previousCheckbox = checkbox
    --         end
    --         levelOptionsFrame:Show()
    --     else
    --         -- Toggle visibility of the frame when the function is called
    --         if levelOptionsFrame:IsShown() then
    --             levelOptionsFrame:Hide()
    --         else
    --             levelOptionsFrame:Show()
    --         end
    --     end
    ...
    -- -- Set up the right-click behavior for the button
    -- hideLevelFrame:SetScript("OnMouseDown", function(self, button)
    --     if button == "RightButton" then
    --         OpenLevelOptionsWindow()
    --     end
    -- end)
...
function BBP.CreateIntroMessageWindow()
    ...
    BBP.IntroMessageWindow:SetSize(470, 370)
    ...
    local textElements = {
        ...
        myProfileButton.Text, blitzButton.Text, button2.Text, buttonLast.Text
    }
