...
- Midnight: Fix "No Trinket" texture not showing. Also reminder that if you want it to keep showing no texture at all enable "Remove Un-Equipped Trinket Texture" now moved into Global Settings -> Trinket
