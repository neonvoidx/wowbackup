...
-- Nem: Pet Alerts — Marksmanship Hunter spec module
--
-- FULLY SELF-CONTAINED. Zero dependencies on other spec modules.
--
-- Marksmanship requires the Unbreakable Bond talent to have a
-- permanent pet. Without it (or with Avian Spec), alerts are
-- suppressed via ShouldRun.
--
-- Alerts:
...
-- Spec Constants
-- =============================================================
local SPEC_ID = 254  -- Marksmanship

-- =============================================================
-- Spell IDs
-- =============================================================
local SPELL_UNBREAKABLE_BOND = 1223323
local SPELL_AVIAN_SPEC       = 466867
...
local function MMHasPetTalent()
    if NPA.IsSpellKnownByPlayer(SPELL_AVIAN_SPEC) then return false end
...
-- OnActivate
-- =============================================================
function HunterMarksmanship:OnActivate(db)
...
-- =============================================================
function HunterMarksmanship:PreEvaluate(db)
    -- CC sound
