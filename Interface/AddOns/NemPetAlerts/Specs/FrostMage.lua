-- =============================================================
-- Specs/FrostMage.lua
-- Nem: Pet Alerts — Frost Mage class module
--
...
-- =============================================================
-- Test Slots (Mage: no fakeDeath or taunt, use passive/notAttacking instead)
-- =============================================================
...
-- ShouldRun
-- =============================================================
function FrostMage:ShouldRun(db)
    if not db.enabled then return false end
    return NPA.GetSpecID() == SPEC_FROST_MAGE
        and NPA.IsSpellKnownByPlayer(SPELL_SUMMON_WATER_ELEMENTAL)
end

-- =============================================================
-- OnActivate
-- =============================================================
function FrostMage:OnActivate(db)
    ...
    if NPA.PetExists() and not UnitIsDead("pet") then
        ...
        -- Start ticker to watch for pet return
...
-- ClearAllState
-- =============================================================
function FrostMage:ClearAllState()
...
-- =============================================================
function FrostMage:PreEvaluate(db)
    -- CC sound
...
-- =============================================================
function FrostMage:GetHighestPriorityAlert(db)
...
-- OnEvent
-- =============================================================
function FrostMage:OnEvent(db, event, ...)
...
function FrostMage:Debug(db)
    ...
    if not ok then NPA.Msg("ERROR(mage): " .. tostring(err)) end
end

-- =============================================================
-- Register
-- =============================================================
NPA:RegisterClass("MAGE", FrostMage)
