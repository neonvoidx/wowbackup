...
-- Nem: Pet Alerts — Destruction Warlock spec module
--
...
-- ShouldRun
-- =============================================================
function WarlockDestruction:ShouldRun(db)
...
-- OnActivate
-- =============================================================
function WarlockDestruction:OnActivate(db)
...
-- ClearAllState
-- =============================================================
function WarlockDestruction:ClearAllState()
...
-- =============================================================
function WarlockDestruction:PreEvaluate(db)
    -- CC sound
...
-- =============================================================
function WarlockDestruction:GetHighestPriorityAlert(db)
...
-- OnEvent
-- =============================================================
function WarlockDestruction:OnEvent(db, event, ...)
...
-- Debug
-- =============================================================
function WarlockDestruction:Debug(db)
    local ok, err = pcall(function()
        NPA.Msg("spec=Destruction"
    ...
    if not ok then NPA.Msg("ERROR(warlock_dest): " .. tostring(err)) end
end

-- =============================================================
-- Register
-- =============================================================
NPA:RegisterSpec("WarlockDestruction", WarlockDestruction)
