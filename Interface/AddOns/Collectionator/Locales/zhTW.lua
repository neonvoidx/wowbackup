...
L["LEVEL_REQUIRED"] = "等級需求"
--[[Translation missing --]]
L["MOUNT_FLYING"] = "Flying"
--[[Translation missing --]]
L["MOUNT_GROUND"] = "Ground"
L["MOUNT_INCLUDE_COLLECTED"] = "包含已收集的坐騎"
--[[Translation missing --]]
...
L["NEED_A_FULL_SCAN"] = "沒有完整的掃描數據。為了使搜索正常進行，必須在此伺服器進行一次完整掃描。"
--[[Translation missing --]]
...
L["PET_INCLUDE_COLLECTED"] = "包含已收集的寵物"
--[[Translation missing --]]
...
L["SHOWING_X_RESULTS"] = "顯示 %s結果"
L["SLOT"] = "部位"
--[[Translation missing --]]
L["START_PURCHASING"] = "Start purchasing"
L["TAB"] = "收集中"
L["TAB_HEADER"] = "Collectionator - 收集中"
--[[Translation missing --]]
...
L["TMOG_COLLECTED"] = "包含已收集的外觀"
--[[Translation missing --]]
L["TMOG_INCLUDE_CRAFTED"] = "Include crafted gear"
L["TMOG_ONLY_THIS_CHARACTER"] = "只限此角色的塑形"
L["TMOG_SHOW_ALL_SOURCES"] = "顯示全部來源"
L["TMOG_UNIQUES"] = "只顯示獨特的外觀(非異色)"
L["TMOG_UNIQUES_TOOLTIP_HEADER"] = "只限獨特外觀"
L["TMOG_UNIQUES_TOOLTIP_TEXT"] = "每個塑形外觀僅顯示一個來源，而不是同一外觀的多個來源。"
L["TMOGS_BUTTON"] = "塑形"
L["TOY_INCLUDE_COLLECTED"] = "包含已收集的玩具"
L["TOY_INCLUDE_UNUSABLE"] = "包含不可用的玩具"
L["TOYS_BUTTON"] = "玩具"
--[[Translation missing --]]
