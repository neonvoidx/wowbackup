...
L["ACTIONBAR_DESC"] = "Настраивайте перезарядки на основных панелях действий, включая Bartender4 и Dominos."
...
L["DYNAMIC_COLORS_GENERAL_DESC"] = "Применяет пороги оставшегося времени к активным категориям MiniCE. Обработка длительности остаётся корректной даже на смене суток, когда Blizzard отдаёт скрытые значения."
