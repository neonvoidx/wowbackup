...
L["DYNAMIC_COLORS_GENERAL_DESC"] = "Applica soglie di tempo rimanente alle categorie MiniCE attive. La gestione della durata resta sicura anche al cambio di mezzanotte quando Blizzard espone valori nascosti."
