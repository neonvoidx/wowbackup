...
{
"Connecting conn=\"(enum)3\" connPtr=\"0000000089152180\" protocol=\"(enum)0\"",
0,
},
{
"KillConnection conn=\"00000001c212d0a0\" state=\"(enum)6\"",
0,
},
{
"Weather changed to 0, intensity 0.000000\n",
...
{
"KillConnection conn=\"0000000089152180\" state=\"(enum)7\"",
0,
},
{
"-------------------------------------------------- Previous Session --------------------------------------------------",
...
{
"Reconnect token saved;  creationTime=\"1783520644\" expirationTime=\"1783535044\"",
0,
},
{
...
{
"Found most recently played char. Joining realm. lastPlayedRegion=\"1-1-89\" realmAddress=\"16973835\" lastActiveTime=\"1783520436\"",
0,
},
{
...
{
"Connecting conn=\"(enum)0\" connPtr=\"000000003de7ae80\" protocol=\"(enum)0\"",
0,
},
{
...
{
"Connecting conn=\"(enum)2\" connPtr=\"000000007b541d00\" protocol=\"(enum)0\"",
0,
},
{
...
{
"KillConnection conn=\"000000003de7ae80\" state=\"(enum)6\"",
0,
},
{
...
{
"Connecting conn=\"(enum)3\" connPtr=\"00000000487445a0\" protocol=\"(enum)0\"",
0,
},
{
...
{
"Connecting conn=\"(enum)3\" connPtr=\"0000000084d1ba50\" protocol=\"(enum)0\"",
0,
},
{
"KillConnection conn=\"00000000487445a0\" state=\"(enum)6\"",
0,
},
{
"Weather changed to 0, intensity 0.000000\n",
...
{
"KillConnection conn=\"0000000084d1ba50\" state=\"(enum)7\"",
0,
},
{
"-------------------------------------------------- Previous Session --------------------------------------------------",
...
{
"BGS_ code=\"ERROR_OK (0)\" name=\"WoW3\" numGameAccounts=\"8\" numGameAccountNames=\"7\"",
0,
},
{
"BGS_ACCO code=\"ERROR_OK (0)\"",
...
{
"Reconnect token saved;  creationTime=\"1783620939\" expirationTime=\"1783635339\"",
0,
},
{
"Waiting for realm list.",
...
{
"Connecting conn=\"(enum)0\" connPtr=\"000000003dcb0c40\" protocol=\"(enum)0\"",
0,
},
{
"Received AuthedToWoW result=\"ERROR_OK (0)\"",
...
{
"Connecting conn=\"(enum)2\" connPtr=\"0000000080143ff0\" protocol=\"(enum)0\"",
0,
},
{
"Switching to screen=\"CharacterSelect\" (from \"login\")",
...
{
"KillConnection conn=\"000000003dcb0c40\" state=\"(enum)6\"",
0,
},
{
"From EnsureValidScreen",
...
{
"Reconnect token saved;  creationTime=\"1783620967\" expirationTime=\"1783635367\"",
0,
},
{
"Waiting for realm list.",
...
{
"Received last played char code=\"ERROR_OK (0)\" subRegion=\"1-1-89\" lastPlayedTime=\"1783521304\" numRegions=\"5\" numRegionsWithData=\"3\" realmPermissions=\"3\" entitlementsCount=\"277\" realmEntry=\"{\"wowRealmAddress\":16973835,\"useBleepChance\":0.0,\"cfgTimezonesID\":1,\"populationState\":6,\"cfgCategoriesID\":2,\"version\":{\"versionMajor\":12,\"versionBuild\":67808,\"versionMinor\":0,\"versionRevision\":7},\"cfgRealmsID\":11,\"gameServiceRegionId\":1,\"flags\":0,\"name\":\"Tichondrius\",\"cfgConfigsID\":1,\"cfgContentSetID\":0,\"cfgLanguagesID\":1}\"",
0,
},
{
"Received last played char code=\" (309)\" subRegion=\"76-1-59\" lastPlayedTime=\"0\" numRegions=\"5\" numRegionsWithData=\"4\" realmPermissions=\"0\" entitlementsCount=\"0\" realmEntry=\"{\"wowRealmAddress\":0,\"useBleepChance\":0.0,\"cfgTimezonesID\":0,\"populationState\":0,\"cfgCategoriesID\":0,\"version\":{\"versionMajor\":0,\"versionBuild\":0,\"versionMinor\":0,\"versionRevision\":0},\"cfgRealmsID\":0,\"gameServiceRegionId\":0,\"flags\":0,\"name\":\"\",\"cfgConfigsID\":0,\"cfgContentSetID\":0,\"cfgLanguagesID\":0}\"",
...
{
"Found most recently played char. Joining realm. lastPlayedRegion=\"1-1-89\" realmAddress=\"16973835\" lastActiveTime=\"1783521304\"",
0,
},
{
"Joining realm subRegion=\"1-1-89\" realmAddress=\"1-3-11\"",
...
{
"Connecting conn=\"(enum)0\" connPtr=\"000000003dca2bc0\" protocol=\"(enum)0\"",
0,
},
{
"Received AuthedToWoW result=\"ERROR_OK (0)\"",
...
{
"Connecting conn=\"(enum)2\" connPtr=\"0000000080165750\" protocol=\"(enum)0\"",
0,
},
{
"Switching to screen=\"CharacterSelect\" (from \"login\")",
...
{
"KillConnection conn=\"000000003dca2bc0\" state=\"(enum)6\"",
0,
},
{
"From EnsureValidScreen",
...
{
"Connecting conn=\"(enum)3\" connPtr=\"0000000047e4e670\" protocol=\"(enum)0\"",
0,
},
{
"Proficiency in item class 2 set to 0x0000000001",
...
{
"Time set to 7/9/2026 (Thu) 11:16",
0,
},
{
"Gamespeed set from 0.017 to 0.017",
...
{
"Connecting conn=\"(enum)3\" connPtr=\"00000000852ef240\" protocol=\"(enum)0\"",
0,
},
{
"KillConnection conn=\"0000000047e4e670\" state=\"(enum)6\"",
0,
},
{
"Weather changed to 0, intensity 0.000000\n",
...
{
"KillConnection conn=\"00000000852ef240\" state=\"(enum)7\"",
0,
},
{
"-------------------------------------------------- Previous Session --------------------------------------------------",
...
{
"BGS_ code=\"ERROR_OK (0)\" name=\"WoW5\" numGameAccounts=\"8\" numGameAccountNames=\"1\"",
0,
},
{
...
{
"Reconnect token saved;  creationTime=\"1783963219\" expirationTime=\"1783977619\"",
0,
},
{
"Waiting for realm list.",
...
{
"Connecting conn=\"(enum)0\" connPtr=\"000000003deccca0\" protocol=\"(enum)0\"",
0,
},
{
"Received AuthedToWoW result=\"ERROR_OK (0)\"",
...
{
"Connecting conn=\"(enum)2\" connPtr=\"000000007d2aeb40\" protocol=\"(enum)0\"",
0,
},
{
"Switching to screen=\"CharacterSelect\" (from \"login\")",
...
{
"KillConnection conn=\"000000003deccca0\" state=\"(enum)6\"",
0,
},
{
"From EnsureValidScreen",
...
{
"Reconnect token saved;  creationTime=\"1783963267\" expirationTime=\"1783977667\"",
0,
},
{
"Waiting for realm list.",
...
{
"Received last played char code=\"ERROR_OK (0)\" subRegion=\"1-1-89\" lastPlayedTime=\"1783621140\" numRegions=\"5\" numRegionsWithData=\"3\" realmPermissions=\"3\" entitlementsCount=\"277\" realmEntry=\"{\"wowRealmAddress\":16973835,\"useBleepChance\":0.0,\"cfgTimezonesID\":1,\"populationState\":6,\"cfgCategoriesID\":2,\"version\":{\"versionMajor\":12,\"versionBuild\":67808,\"versionMinor\":0,\"versionRevision\":7},\"cfgRealmsID\":11,\"gameServiceRegionId\":1,\"flags\":0,\"name\":\"Tichondrius\",\"cfgConfigsID\":1,\"cfgContentSetID\":0,\"cfgLanguagesID\":1}\"",
0,
},
{
"Received last played char code=\" (309)\" subRegion=\"76-1-59\" lastPlayedTime=\"0\" numRegions=\"5\" numRegionsWithData=\"4\" realmPermissions=\"0\" entitlementsCount=\"0\" realmEntry=\"{\"wowRealmAddress\":0,\"useBleepChance\":0.0,\"cfgTimezonesID\":0,\"populationState\":0,\"cfgCategoriesID\":0,\"version\":{\"versionMajor\":0,\"versionBuild\":0,\"versionMinor\":0,\"versionRevision\":0},\"cfgRealmsID\":0,\"gameServiceRegionId\":0,\"flags\":0,\"name\":\"\",\"cfgConfigsID\":0,\"cfgContentSetID\":0,\"cfgLanguagesID\":0}\"",
...
{
"Found most recently played char. Joining realm. lastPlayedRegion=\"1-1-89\" realmAddress=\"16973835\" lastActiveTime=\"1783621140\"",
0,
},
{
"Joining realm subRegion=\"1-1-89\" realmAddress=\"1-3-11\"",
...
{
"Connecting conn=\"(enum)0\" connPtr=\"000000000b106b40\" protocol=\"(enum)0\"",
0,
},
{
"Received AuthedToWoW result=\"ERROR_OK (0)\"",
...
{
"Connecting conn=\"(enum)3\" connPtr=\"000000007acfa160\" protocol=\"(enum)0\"",
0,
},
{
...
{
"Time set to 7/13/2026 (Mon) 10:21",
0,
},
{
"Gamespeed set from 0.017 to 0.017",
